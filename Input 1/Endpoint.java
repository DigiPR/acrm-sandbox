...
public class Endpoint {
    ...
    public List<Partner> getPartners() {
        return partnerService.myPartnerships();
    }

    @PostMapping(path = "/partner", consumes = "application/json", produces = "application/json")
    public ResponseEntity<Partner> postPartner(@RequestBody Partner partner) {
        try {
            partner = partnerService.enterBusinessPartnership(partner);
        ...
        URI location = ServletUriComponentsBuilder
                .fromCurrentRequest().path("/{partnerId}")
