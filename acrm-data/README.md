...
Create the `ch.fhnw.acrm.data.domain` package and in this package the following domain objects / entities including getters and setters:
...
Create the `ch.fhnw.acrm.data.repository` package and in this package the following repository interfaces:
